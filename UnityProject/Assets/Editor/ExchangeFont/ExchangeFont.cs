...
namespace TEngine.Editor
{
    public class ExchangeFont : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            GUILayout.Space(5);
            oldTextMeshProFont = (TMP_FontAsset)EditorGUILayout.ObjectField("选择被更换的TextMesh字体", oldTextMeshProFont,
            ...
            GUILayout.Space(10);
            selectTextFont = (Font)EditorGUILayout.ObjectField("选择新的Text字体", selectTextFont, typeof(Font), true,
                GUILayout.MinWidth(100));
            GUILayout.Space(5);
            selectTextMeshProFont = (TMP_FontAsset)EditorGUILayout.ObjectField("选择新的TextMesh字体", selectTextMeshProFont,
                typeof(TMP_FontAsset), true, GUILayout.MinWidth(100));
            GUILayout.Space(5);
        ...
        public static void ChangeFont(List<GameObject> targetkLists)
        {
            ...
            {
                EditorUtility.DisplayProgressBar("开始替换字体", "Show a progress bar for the given seconds",
                    curCount / maxCount);
                ...
                var tmpUGUIs = targetkLists[i].GetComponentsInChildren<TextMeshProUGUI>(true);
        ...
        static void ChangeTextMeshProUGUI(TextMeshProUGUI[] lists)
        {
